...
export class BoardArticleService {
    ...
    public async createBoardArticle(memberId: ObjectId, input: BoardArticleInput): Promise<BoardArticle> {
        ...
        try {
            ...
            console.log("Erorr, Service.module:", err);
    ...
    public async updateBoardArticle(memberId: ObjectId, input: BoardArticleUpdate): Promise<BoardArticle> {
        ...
        const result = await this.boardArticleModel.findOneAndUpdate({ _id: _id, memberId: memberId, articleStatus: BoardArticleStatus.ACTIVE }, input, { new: true }).exec()
    ...
    public async getBoardArticles(memberId: ObjectId, input: BoardArticlesInquiry): Promise<BoardArticles> {
        ...
        const result = await this.boardArticleModel.aggregate([{ $match: match }, { $sort: sort }, {
            $facet: {
